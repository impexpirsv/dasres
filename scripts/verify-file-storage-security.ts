...
assert.match(publicImageMigration, /--acknowledge-production-read-only/);
assert.match(publicImageMigration, /mode === "inventory"/);
assert.match(publicImageMigration, /mode === "dry-run"/);
assert.match(publicImageMigration, /mode === "apply"/);
assert.match(publicImageMigration, /Production apply requires --production --apply --acknowledge-production/);
