...
export default async function ProjectAIInsights({
    ...
    pendingApprovals.length > 0
      ...
      : blockedTasks.length > 0
        ...
        : overdueTasks.length > 0
          ...
          : progress < 100
            ? t(
                "nextActions.continueExecution",
              )
            : t(
                "nextActions.completionReview",
              );
  ...
  const recommendation =
    pendingApprovals.length > 0
      ...
      : blockedTasks.length > 0
        ? t(
            "recommendations.blockedTasks",
          )
        : overdueTasks.length > 0
          ? t(
              "recommendations.overdueTasks",
            )
          : t(
              "recommendations.normalProgress",
            );
